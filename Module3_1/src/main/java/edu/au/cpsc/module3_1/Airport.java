 ...
 * Date: 1-22-2026
 * Description: Represents an Airport with fields from the CSV file and provides a method to read all airports from the CSV.
 */

public class Airport {

    // Instance variables mapped from CSV columns
    private Integer elevationFt;     // elevation_ft
    private String continent;        // continent
    private String country;          // country
    private String region;           // iso_region
    private String municipality;     // municipality
    private Integer gpsCode;         // gps_code
    ...
    public static List<Airport> readAll() throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(is))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                // Parse fields, handling nullable numeric values
                ...
                String localCode    = data[6].isEmpty() ? null : data[6];
